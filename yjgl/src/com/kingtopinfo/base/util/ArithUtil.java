...
public class ArithUtil {
    ...
    public static double div(double v1, double v2) {
        BigDecimal b1 = new BigDecimal(Double.toString(v1));
        BigDecimal b2 = new BigDecimal(Double.toString(v2));
        return b1.divide(b2, DEF_SCALE, BigDecimal.ROUND_HALF_UP).doubleValue();
    }
     ...
     * 
      * @Title:  ArithUtil
      * @param:  @param d  任意一个科学计数法形式的浮点数
      * @param:  @return   
      * @return:  返回普通浮点形式对应的字符串     
      * @throws:
      * @Description: TODO 将一个科学计数法形式的浮点数转成普通浮点的字符串
     */
    public static String getDecimalStr(Double d){
    	String str = Double.toString(d);
		BigDecimal bg = new BigDecimal(str);
		String str1 = bg.toPlainString();
		return str1;
    }
}
