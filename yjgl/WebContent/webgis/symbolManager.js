define([
	...
	return declare("SymbolManager", null, { 
		...
		baseSearch_pointSymbol:null, //点查询结果高亮显示
		
		baseEdit_fillSymbol:null,//编辑缓存高亮面样式
		baseEdit_markSymbol:null,
		baseEdit_pointSymbol:null, //编辑缓存高亮点显示
		 ...
		 */
		mapSymbol:function(){
			this.mapPointSymbol = new PictureMarkerSymbol('../images/webgis/symbol/locate.png',30, 30);//地图高亮点样式
		...
		querySymbol:function(){
			this.baseSearch_fillSymbol = new SimpleFillSymbol(SimpleFillSymbol.STYLE_NULL,
					new SimpleLineSymbol(SimpleLineSymbol.STYLE_SOLID,
							new Color([ 255,0,0 ]), 1), new Color([ 255, 255, 0,1 ]));
			this.baseSearch_pointSymbol = new SimpleMarkerSymbol(SimpleMarkerSymbol.STYLE_CIRCLE, 18,
